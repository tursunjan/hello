	...
	if(p!=NULL&&(p->next)==NULL )
		...
		else
		{
			...
			while(q!=NULL && (q->pos1&0x3f00000000)==(bp1_pos1&0x3f00000000) )
			{
				...
				{
					score(&label,Area,bp1_pos1,bp1_pos2,q->pos1,q->pos2 );
					print_type(label,&en_single,bp1_pos1,bp1_pos2,q->pos1,q->pos2);
				}
				q=q->next;
			}
...
void print_type(int label,int *en_single,unsigned long long int bp1_pos1,unsigned long long int bp1_pos2 ,unsigned long long int bp2_pos1,unsigned long long int bp2_pos2 )
{
        ...
        if((label&0xff)==195 || (label&0xff)==53){ (*en_single)=1;
        ...
        if((label&0xff)==25 || (label&0xff)==201){ (*en_single)=1;
                printf( "INV/TRS4\tchr%lld\t%lld\t%lld\n",(bp1_pos1&0x3f00000000)>>32,bp1_pos1&0x3fffffff,bp1_pos2&0x3fffffff);
        }
        if(((label&0xff)==200 && label&0x100) || ((label&0xff)==56 && !label&0x100)
                 || ((label&0xff)==193 && label&0x200) || ((label&0xff)==49 && !label&0x100) ){ (*en_single)=1;
                printf( "CNV2\tchr%lld\t%lld\t%lld\t%lld\n",(bp1_pos1&0x3f00000000)>>32,bp1_pos1&0x3fffffff,bp2_pos1&0x3fffffff,bp2_pos2&0x3fffffff);
        }
        if(((label&0xff)==104 && label&0x100) || ((label&0xff)==152 && !label&0x100)
                 || ((label&0xff)==145 && label&0x200) || ((label&0xff)==97 && !label&0x100) ){ (*en_single)=1;
                printf( "CNV1\tchr%lld\t%lld\t%lld\t%lld\n",(bp1_pos1&0x3f00000000)>>32,bp1_pos1&0x3fffffff,bp2_pos1&0x3fffffff,bp2_pos2&0x3fffffff);
        }
        if(((label&0xff)==120 && label&0x100) || ((label&0xff)==40 && label&0x100)
                 || ((label&0xff)==65 && label&0x200) || ((label&0xff)==225 && label&0x100) ){ (*en_single)=1;
                printf( "TRS2\tchr%lld\t%lld\t%lld\t%lld\t%lld\n",(bp1_pos1&0x3f00000000)>>32,bp1_pos1&0x3fffffff,bp1_pos2&0x3fffffff,bp2_pos1&0x3fffffff,bp2_pos2&0x3fffffff);
        }
        if(((label&0xff)==120 && !label&0x100) || ((label&0xff)==40 && !label&0x100)
                 || ((label&0xff)==17 && label&0x200) || ((label&0xff)==177 && label&0x100) ){ (*en_single)=1;
