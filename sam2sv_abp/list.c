...
void fprint_abp(FILE *org_abp,PosNode *L)
{
	...
	else
	{
		while(NULL != p)
                {
			if( ((p->pos1)&0xffffff0000000000) < ((p->pos2)&0xffffff0000000000)  )
				fprintf(org_abp,"T\t");
...
void print_abp(PosNode *L )
{
	...
	else
	{
		while(NULL != p)
		{
			if(((p->pos1)&0xffffff0000000000) > 0x10000000000 && ((p->pos2)&0xffffff0000000000)> 0x10000000000)
				printf("H/T\t");
			else if( ((p->pos1)&0xffffff0000000000) > ((p->pos2)&0xffffff0000000000)> 0x10000000000 )
				printf("H\t");
			else printf("T\t");
